...
Climate Data:
Currently we are still exploring how to best manage our data, based on the recent change of administration, access to NOAA data has been stipled. We have still not completely pulled data reflecting the entire scope of the western coast, however, there are weather stations we have pulled from Phoenix, Arizona to begin. 


**Methods**

1. Create time period for seasons
2. Focus on temperature shifts
3. Temperature data set that encompasses bird migration
4. Focused area (region)
5. NOAA temperature dataset
